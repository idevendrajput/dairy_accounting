...
import com.dr.dairyaccounting.databinding.FragmentPurchasesMorningBinding
...
class PurchasesMorning : Fragment() {

    private lateinit var binding: FragmentPurchasesMorningBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPurchasesMorningBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun initData() {
        ...
        val list = getTodayMorningPurchase(mContext)
    ...
    private fun update(list: ArrayList<RecordsEntity> ) {
        ...
        binding.rv.adapter = AdapterDefaultRecords(list, object : RecordView {
            override fun recordViw(itemView: View, recordId: String) {
                itemView.setOnClickListener {
                    ...
                    args.putString(SELECTED_ITEM, recordId)
        ...
        printExcel.setOnMenuItemClickListener {
            createExcel(
                mContext, list, "Morning Purchase ".plus(
                    SimpleDateFormat("dd MMM y", Locale.ENGLISH).format(
                        Date(
...
//            }
    ...
    private fun search(s: String) {
        ...
        printExcel.setOnMenuItemClickListener {
            createExcel(
                mContext, result, "Morning Purchase ".plus(
                    SimpleDateFormat("dd MMM yyyy", Locale.ENGLISH).format(
                        Date(
                            getCalendarTime(mContext)
                        )
    ...
    private fun saveUpdate() {
        ...
        val records = getTodayMorningPurchase(mContext)
