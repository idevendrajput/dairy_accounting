...
import com.dr.dairyaccounting.utils.Utils.Companion.getTodayEveningSale
import com.dr.dairyaccounting.database.RecordsEntity
import com.dr.dairyaccounting.databinding.FragmentSaleEveningBinding
...
class SaleEvening : Fragment() {

    private lateinit var binding: FragmentSaleEveningBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSaleEveningBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun initData() {
        ...
        val list = getTodayEveningSale(mContext)
    ...
    private fun update(list: ArrayList<RecordsEntity> ) {
        ...
        printExcel.setOnMenuItemClickListener {
            createExcel(
                mContext, list, "Evening Sale ".plus(
...
//            }
    ...
    private fun search(s : String) {
        ...
        printExcel.setOnMenuItemClickListener {
            createExcel(
                mContext, result, "Evening Sale ".plus(
                    SimpleDateFormat("dd MMM yyyy", Locale.ENGLISH).format(
                        Date(
                            Utils.getCalendarTime(mContext)
                        )
    ...
    private fun cancelUpdates() {
        ...
        // re-install updates firebase to room while canceling updates

        db.collection(AppConstants.COLLECTIONS_RECORDS)
            .whereEqualTo(AppConstants.DATE, Utils.getTodayDate())
            .get().addOnSuccessListener {
                ...
                for ((i,d) in it.withIndex()) {
                    ...
                    try {
                        ...
                        val recordType = d[RECORD_TYPE].toString()
    ...
    private fun saveUpdate() {
        ...
        val records = getTodayEveningSale(mContext)
